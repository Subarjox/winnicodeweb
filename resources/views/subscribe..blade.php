...
<body class="g-sidenav-show" style="background-image: url('../assets/img/Berita\ Baru\,\ Setiap\ Hari.png'); background-size: cover; background-position: center;  background-repeat: no-repeat; min-height: 100vh;">
    ...
    <div class="container-fluid py-4 px-4">
      ...
      <div class="row mt-8 ">
        <div class="col-lg-12 mb-lg-0 mb-4 ">
          <div class="card body">
            <div class="card-body p-5 border-radius-lg">
                <h6 class="font-weight-bolder mb-0">Berita Baru, Setiap Hari. Subscribe</h6>
              <div class="row mt-4">
                <div class="col-lg-12">
                    <div class="input-group">
                        <span class="input-group-text text-body"><i class="fas fa-bell" aria-hidden="true"></i></span>
