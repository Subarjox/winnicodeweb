...
<head>
  ...
  <link rel="apple-touch-icon" sizes="76x76" href="{{ asset('media/logo.png') }}">
...
<body class="g-sidenav-show  bg-gray-100">
  <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
    <div class="sidenav-header">
      ...
      <a class="navbar-brand m-0" href="https://winnicode.com/">
        <img src="{{ asset('media/logo.png') }}" class="navbar-brand-img h-100" alt="main_logo">
  ...
  <main class="main-content position-relative max-height-vh-100 h-100 border-radius-lg ">
    <x-jurnavbar :username="$username" page="Edit Berita" />
          ...
          <div class="col-lg-12 mb-lg-0 mb-4">
            <div class="card">
              <div class="card-body p-4">
                ...
                <form role="form" method="POST" enctype="multipart/form-data" action="{{ route('berita.update', $berita->id_berita) }}">
                  ...
                  <div class="mb-3">
                    <div id="drop-zone" class="w-100 min-height-400 text-center p-4 border border-dashed rounded border-secondary" style="cursor:pointer;">
                      ...
                      <input type="file" id="file-input" accept="image/*" class="form-control d-none">
                      <img img src="{{ asset('storage/uploads/' . basename($berita->gambar)) }}" id="preview" class="img-fluid mt-3 border-radius-lg d-block mx-auto" style="max-height: 200px; display: none;" />
                    </div>
                  </div>
                  ...
                  <div class="mb-3">
                    <input type="text" class="form-control" placeholder="{{ $berita->judul }}" aria-label="Judul" value="{{ $berita->judul }} " name="judul">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" class="form-control" placeholder="{{ $berita->kategori }}" aria-label="Kategori" value="{{ $berita->kategori }}" name="kategori"> </input>
                  ...
                  <div class="mb-3">
                    <textarea class="form-control min-height-200 align-text-bottom" rows="3" placeholder="{{ $berita->deskripsi }}" aria-label="Deskripsi" value="{{ $berita->deskripsi }}" name="deskripsi"></textarea>
                  </div>
      
                  <!-- Tombol Submit -->
                  <button type="submit" class="btn bg-gradient-info w-100 mt-4 mb-3">Edit Berita</button>
                </form>
                
                <form method="POST" action="{{ route('berita.delete', $berita->id_berita) }}">
                    @csrf
                    <button type="submit" class="btn bg-gradient-danger w-100 mt-4 mb-0">Hapus Berita</button>
                </form>
              </div>
            </div>
          </div>
